        ...
        {/* features || message history */}
        {
          messages.length>0? (
            <View className="flex-1 space-y-2">
              <Text className="ml-1 font-semibold text-gray-700" style={{fontSize: wp(5)}}>Assistant</Text>
        
              <View 
                style={{height: hp(58)}} 
                className="p-4 bg-neutral-200 rounded-3xl">
                  <ScrollView  
                    ref={scrollViewRef} 
                    bounces={false} 
                    className="space-y-4" 
                        ...
                        if(message.role=='assistant'){
                          if(message.content.includes('https')){
                            ...
                            return (
                              <View key={index} className="flex-row justify-start">
                                <View 
                                  className="flex p-2 rounded-tl-none rounded-2xl bg-emerald-100">
                                    <Image  
                            ...
                            return (
                              <View 
                                ...
                                className="p-2 rounded-tl-none bg-emerald-100 rounded-xl">
                          ...
                          return (
                            <View key={index} className="flex-row justify-end">
                              <View 
                                style={{width: wp(70)}} 
                                className="p-2 bg-white rounded-tr-none rounded-xl">
        ...
        <View className="flex items-center justify-center">
              ...
              recording ? (
                <TouchableOpacity className="space-y-2" onPress={stopRecording}>
                  ...
                  <Image 
                    ...
                    source={require('../../assets/images/voice.webp')}
                    style={{width: hp(10), height: hp(10)}}
                  />
                </TouchableOpacity>
                ...
                <TouchableOpacity onPress={startRecording}>
                  ...
                  <Image 
                    className="rounded-full" 
                    source={require('../../assets/images/recording.webp')}
                    style={{width: hp(10), height: hp(10)}}
                  />
                </TouchableOpacity>
              )
          }
          {
            messages.length>0 && (
              <TouchableOpacity 
                onPress={clear} 
                className="absolute p-2 bg-neutral-400 rounded-3xl right-10"
              >
          ...
          }
          {
            speaking && (
              <TouchableOpacity 
                ...
                className="absolute p-2 bg-red-400 rounded-3xl left-10"
              >
